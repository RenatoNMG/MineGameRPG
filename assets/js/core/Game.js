...
import {GateFeature} from "../features/fence/GateFeature.js";
...
export class Game{
  constructor(){
    ...
    this.ui=new GameUI(this);this.loop=new GameLoop(this);this.ui.renderInventory();this.ui.renderQuickbar();this.loop.start();
  }
}
