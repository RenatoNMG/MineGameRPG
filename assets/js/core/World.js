import {Config} from "./Config.js";import {Tree} from "../entities/Tree.js";import {Stone} from "../entities/Stone.js";import {Enemy} from "../entities/Enemy.js";export class World{
 ...
 near.forEach(([dx,dy],i)=>{
   ...
   addStone(x,y,.95+(i%3)*.15,i%3,i<3);
 });
