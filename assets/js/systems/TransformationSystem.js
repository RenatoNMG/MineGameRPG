...
export class TransformationSystem{
  ...
  updateRoosters(dt){const w=this.world;for(let i=w.roosters.length-1;i>=0;i--){const rooster=w.roosters[i];rooster.age=(rooster.age||0)+dt;if(rooster.age>=this.chickenLifespan){w.roosters.splice(i,1);}}}
